...
local resourceName = "eric_moneywash"

local GetRepoInformations = function()
    local repoVersion, repoURL, repoBody = nil, nil, nil

    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_moneywash/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://github.com/AiReiKe/eric_moneywash"
        end
    end, "GET")
...
CreateThread(function()
    if GetCurrentResourceName() ~= "eric_moneywash" then
        resourceName = "eric_moneywash (" .. GetCurrentResourceName() .. ")"
    end
    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_moneywash/releases/latest", CheckVersion, "GET")
end)